...
class SingleClubFrame extends StatelessWidget {
  const SingleClubFrame({Key? key}) : super(key: key);
                            ...
                            Column(
                              ...
                              [
                                ...
                                SizedBox(
                                    ...
                                    child: Image.asset(ImagesUrl.blueFrame)),
                                Row(
                            ...
                            Column(
                              ...
                              [
                                ...
                                SizedBox(
                                    height: size.height * 0.15,
                                    width: size.width * 0.3,
                                    child: Image.asset(ImagesUrl.yelloFrame)),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  children:
                                  [
