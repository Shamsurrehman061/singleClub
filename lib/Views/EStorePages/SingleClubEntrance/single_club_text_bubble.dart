...
class SingleClubTextBubble extends StatelessWidget {
  const SingleClubTextBubble({Key? key}) : super(key: key);
                            ...
                            Column(
                              ...
                              [
                                ...
                                SizedBox(
                                    ...
                                    child: Image.asset(ImagesUrl.blueBubble)),
                                Row(
                            ...
                            Column(
                              ...
                              [
                                ...
                                SizedBox(
                                    height: size.height * 0.15,
                                    width: size.width * 0.3,
                                    child: Image.asset(ImagesUrl.yellowBubble)),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  children:
                                  [
