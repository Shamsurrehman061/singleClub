...
class SingleClubTheme extends StatelessWidget {
  const SingleClubTheme({Key? key}) : super(key: key);
                    ...
                    [
                      Container(
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: AssetImage(ImagesUrl.blueTheme),
                          ),
                        ),
                        ...
                        child: Stack(
                          children: [
                            Column(
                              children:
                              [
                                //Expanded(child: Image.asset(ImagesUrl.blueTheme)),
                                SizedBox(
                                ...
                                Row(
                                  ...
                                  [
                                    ...
                                    Text("Hunda R15", style: TextStyle(fontSize: size.width * 0.05, color: Colors.white),),
                                  ],
                                ),
                                Row(
                                  children:
                      ...
                      Container(
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(10.0),
                          image: DecorationImage(
                            image: AssetImage(ImagesUrl.darkTheme),
                          ),
                        ),

                        child: Stack(
                          children: [
                            //Expanded(child: Image.asset(ImagesUrl.darkTheme)),
                            Column(
                              children:
                              [
                                SizedBox(
                                ...
                                Row(
                                  ...
                                  [
                                    ...
                                    Text("Lamber Giny", style: TextStyle(fontSize: size.width * 0.05, color: Colors.white),),
                                  ],
                                ),
                                Row(
                                  children:
