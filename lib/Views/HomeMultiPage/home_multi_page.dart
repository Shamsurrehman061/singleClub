...
import '../LiveStream/LiveAudioChat/pk_heart_1.dart';


class HomeMulti extends StatelessWidget {
  const HomeMulti({Key? key}) : super(key: key);
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    [
                      ...
                      Text("Multi", style: TextStyle(color: Colors.white, fontSize: size.width * 0.04, fontWeight: FontWeight.bold),),
                      GestureDetector(
                        onTap: (){
                          ...
                          [
                            ...
                            Positioned(
                              ...
                              child: Row(
                                ...
                                children:
                                [
                                  Image.asset(ImagesUrl.giftUser1),
                                  Image.asset(ImagesUrl.giftUser2),
                                  Image.asset(ImagesUrl.giftUser3),
                                  Image.asset(ImagesUrl.giftUser1),
                                  Image.asset(ImagesUrl.giftUser2),
                                  Image.asset(ImagesUrl.giftUser3),
                                ],
