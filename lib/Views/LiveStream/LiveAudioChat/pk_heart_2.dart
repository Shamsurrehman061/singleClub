...
class PkHeart2 extends StatefulWidget {
  const PkHeart2({Key? key}) : super(key: key);

  @override
  State<PkHeart2> createState() => _PkHeart2State();
}

class _PkHeart2State extends State<PkHeart2> {
                    ...
                    [
                      Container(
                        ...
                        child: Row(
                          children:
                          [
                            SvgPicture.asset(ImagesUrl.ruby1, height: size.height * 0.025,),
                            SizedBox(
                              width: size.width * 0.03,
                            ),
                            Text("192998", style: TextStyle(color: Colors.white, fontSize: size.width * 0.055),),
                          ],
                        ),
                      ),
                      SizedBox(
                      ...
                      Container(
                        ...
                        child: Row(
                          children:
                          [
                            Image.asset(ImagesUrl.yellowStar, height: size.height * 0.03,),
                            SizedBox(
                              width: size.width * 0.03,
                            ),
                            Text("192998", style: TextStyle(color: Colors.white, fontSize: size.width * 0.055),),
                          ...
                          Row(
                            ...
                            [
                              Expanded(
                                child: Stack(
                                  children: [
                                    Image.asset(ImagesUrl.leftPlaceHolder, width: double.infinity, fit: BoxFit.cover,),
                                    Positioned(
                              ...
                              Expanded(
                                child: Stack(
                                  children: [
                                    Image.asset(ImagesUrl.rightPlaceHolder,width: double.infinity, fit: BoxFit.cover,),
                                    Positioned(
                                      top: size.height * 0.22,
                                      left: size.width * 0.05,
                                      right: size.width * 0.05,
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          ...
                                          [
                                            ...
                                            SvgPicture.asset(ImagesUrl.flame, height: size.height * 0.025,),
                                            SizedBox(
                                              width: size.width * 0.02,
                                            ),
                                            SizedBox(
                                              width: size.width * 0.1,
                                              child: Text("Rocky", overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: size.width * 0.03, ),),
                                            ),
                                            ...
                                            Container(
                                              ...
                                              child: Icon(Icons.add, size: size.height * 0.02, color: Colors.white,),
                                            ),
                                            SizedBox(
                                              width: size.width * 0.01,
                                            ),
