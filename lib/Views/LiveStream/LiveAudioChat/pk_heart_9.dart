...
class SingleLiveStream9 extends StatefulWidget {
  const SingleLiveStream9({Key? key}) : super(key: key);

  @override
  State<SingleLiveStream9> createState() => _SingleLiveStream9State();
}

class _SingleLiveStream9State extends State<SingleLiveStream9> {
                                ...
                                children: [
                                  ...
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text("Anchor", style: TextStyle(color: Colors.black, fontSize: size.width * 0.035),),
                                    ),
                                  ),
                                  Positioned(
                                      top: size.height * 0.01,
                                    ...
                                    [
                                      ...
                                      Positioned(
                                        ...
                                        child: Container(
                                          padding: EdgeInsets.symmetric(horizontal: size.width * 0.01),
                                          color: Color(0xffFFFFFF).withOpacity(0.5),
                                          child: Text("6", style: TextStyle(color: Colors.white, fontSize: size.width * 0.045),),
                                        ),
                                      ),
                                      Positioned(
                                          top: size.height * 0.01,
                                    ...
                                    [
                                      ...
                                      Positioned(
                                        ...
                                        child: Container(
                                          padding: EdgeInsets.symmetric(horizontal: size.width * 0.01),
                                          color: Color(0xffFFFFFF).withOpacity(0.5),
                                          child: Text("7", style: TextStyle(color: Colors.white, fontSize: size.width * 0.045),),
                                        ),
                                      ),
                                      Positioned(
                                          top: size.height * 0.01,
                                    ...
                                    [
                                      ...
                                      Positioned(
                                        ...
                                        child: Container(
                                          padding: EdgeInsets.symmetric(horizontal: size.width * 0.01),
                                          color: Color(0xffFFFFFF).withOpacity(0.5),
                                          child: Text("8", style: TextStyle(color: Colors.white, fontSize: size.width * 0.045),),
                                        ),
                                      ),
                                      Positioned(
                                          top: size.height * 0.01,
                                    ...
                                    [
                                      ...
                                      Positioned(
                                        ...
                                        child: Container(
                                          padding: EdgeInsets.symmetric(horizontal: size.width * 0.01),
                                          color: Color(0xffFFFFFF).withOpacity(0.5),
                                          child: Text("9", style: TextStyle(color: Colors.white, fontSize: size.width * 0.045),),
                                        ),
                                      ),
                                      Positioned(
                                          top: size.height * 0.01,
