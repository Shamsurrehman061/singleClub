...
class VisitorProfile extends StatefulWidget {
  const VisitorProfile({Key? key}) : super(key: key);
              ...
              Column(
                ...
                [
                      ...
                      [
                        Row(
                          ...
                          [
                            ...
                            Text("ID: 321123", style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold, fontSize: size.width * 0.045),)
                          ],
                        ),
                        Text("Model", style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold, fontSize: size.width * 0.045),)
                      ],
                    ),
                  ),
                      ...
                      [
                        Container(
                          ...
                          child: Row(
                            children:
                            [
                              SvgPicture.asset(ImagesUrl.personGroup, color: Colors.white,),
                              SizedBox(
                                width: size.width * 0.01,
                              ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        SvgPicture.asset(ImagesUrl.frameSilver, height: size.height * 0.05, fit: BoxFit.cover),
                        SvgPicture.asset(ImagesUrl.frameGold, height: size.height * 0.07, fit: BoxFit.cover),
                        SvgPicture.asset(ImagesUrl.framePlatinium, height: size.height * 0.05, fit: BoxFit.cover),
                      ]
                    ),
                  ),
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        Image.asset(ImagesUrl.level40),
                                        Text("Shared From", style: TextStyle(fontSize: size.width * 0.045,),),
                                      ],
                                    ),
                                    Text("Bangladesh  Friday, 21 April 2023 - 12:35 PM"),
                                  ],
