              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text("Foot Print", style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold, fontSize: size.width * 0.06),),
                        ...
                        [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  Text("Join 25/Feb/2022", style: TextStyle(color: Colors.black, fontSize: size.width * 0.035,),),
                                  SizedBox(
                                    width: size.width * 0.02,
                                  ),
                                  Text("Left 12:39 PM 12:57 PM", style: TextStyle(color: Colors.black, fontSize: size.width * 0.035,),),
                                ],
                              ),
                            ],
                          ),
