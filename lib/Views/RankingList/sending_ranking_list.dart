...
class SendingRankingList extends StatefulWidget {
  const SendingRankingList({Key? key}) : super(key: key);

  @override
  State<SendingRankingList> createState() => _SendingRankingListState();
}

class _SendingRankingListState extends State<SendingRankingList> {
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text("Send Ranking", style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold, fontSize: size.width * 0.06),),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        [
                          ...
                          Text("12.7 M", style: TextStyle(color: Color(0xff000000), fontSize: size.width * 0.05, fontWeight: FontWeight.bold),),
                          SizedBox(
